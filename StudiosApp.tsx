      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[90] bg-black/95 backdrop-blur-xl pt-24 px-4 md:hidden overflow-y-auto">
          <div className="flex flex-col gap-6 items-center text-center min-h-full justify-center pb-20">
            ...
            <a 
              href="/"
              className="text-lg text-gray-500 hover:text-white transition-colors"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              ← Back to Flax
            </a>
    ...
    <div className="relative grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
      ...
      <div className="text-center lg:text-left">
        ...
        <div className="inline-block mb-8 opacity-0 animate-fade-in-up">
          <div className="inline-flex items-center justify-center rounded-full bg-primary/10 px-4 py-1.5 text-xs font-mono text-primary border border-primary/20">
...
const FormatSection: React.FC = () => (
  <Section id="format" className="relative border-t border-white/5">
